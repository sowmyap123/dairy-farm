					...
					<div class="modal_body_left modal_body_left1">
						...
						<p>
						 ...
						 <form   method="post" action="dashboard.php">
							...
							<input type="submit" name="sbumit" value="Sign In">
						</form>
						<div class="clearfix"></div>
					</div>
					<div class="clearfix"></div>
			...
			<div class="modal-content">
				...
				<div class="modal-body modal-body-sub_agile">
					...
					<div class="modal_body_left modal_body_left1">
						...
						<p>
							Come join the Dairy Farm! Let's set up your Account.
						</p>
						...
						<div class="styled-input agile-styled-input-top">
							...
							<div class="styled-input">
								<input type="password" placeholder="Password" name="password" id="password_1" required="">
							</div>
							<div class="styled-input">
								<input type="password" placeholder="Confirm Password" name="password" id="password_2" required="">
							</div>
							<div class="styled-input">
					...
					<div class="container-fluid">
						...
						<div class="collapse navbar-collapse menu--shylock" id="bs-example-navbar-collapse-1">
							<ul class="nav navbar-nav menu__list">
								<li class="active">
									<a class="nav-stylehead" href="main.php">Home
										...
										<div class="agile_inner_drop_nav_info">
											<div class="col-sm-4 multi-gd-img">
												<ul class="multi-column-dropdown">
													...
													<li>
														<a href="product.php">Gee</a>
													</li>
													<li>
														<a href="product.php">Curd</a>
													</li>
													<li>
														<a href="product.php">Butter</a>
													</li>
												</ul>
											</div>
								...
								<li class="">
									<a class="nav-stylehead" href="Breeds.php">Breeds</a>
								</li>
								<li class="">
									<a class="nav-stylehead" href="store.php">Store</a>
								</li>
								<li class="">
									<a class="nav-stylehead" href="fooder.php">Fooder</a>
								</li>
