					...
					if($size<(1024*1024))
					{
						if($ext==".jpg" || $ext==".png" || $ext==".gif" || $ext==".jpeg" )
						{
							if(move_uploaded_file($tmp,"img/".$uq."_".$filename))
							{
								...
								$stmt = mysqli_query($conn,"INSERT INTO `storehistory`(`sid`, pid,`action`, `description`) VALUES ('".$_SESSION['aid']."','".$last_id."','insert','Inserted the product')");
	...
	<div class="row">
		<div class="col-lg-8">
			...
			<div class="form-group">
				<label>Product Name <?php echo $_SESSION['aid'];?></label>
