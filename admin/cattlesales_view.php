...
{
	$reslt = mysqli_query($conn,"SELECT * from salescattle where (cid ='".$_GET['cattleid']."' AND location like '%".$_GET['location']."%' )");
...
<div class="page-wrapper">
 ...
 <form action="cattlesales_view.php" method="get">
<div class="card-body">
...
<div class="form-group row">
   ...
   </label><div class="col-sm-9 col-form-label"><?php echo $getrows['birth'];?></div></div>
    ...
    <div class="form-group row"><label class="col-sm-3 text-right control-label col-form-label" for="psw-repeat"><b>rate:</b>
   ...
   <div class="card-body">	
<a class="btn btn-primary" href="cattlesales_edit.php?cid=<?php echo $getrows['cid'];?>">Update</a>
<a  class="btn btn-primary" href="cattlesales_delete.php?cid=<?php echo $getrows['cid'];?>">Delete</a>
</div>
			<?php
