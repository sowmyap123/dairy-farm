...
if(isset($_GET['sname']))
{
	$reslt = mysqli_query($conn,"SELECT * from stockfeeding where (pname ='".$_GET['sname']."' AND location like '%".$_GET['location']."%' )");
             ...
             <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">stock feeding Info</h4>
...
<?php if($count == 0)
				{ ?>
				<div class="col-group">
					<h3> No results Found oF <?php echo $_GET['sname']; ?></h3>
				</div>
				 <?php
				 } else
				 {?>
