...
{
	$reslt = mysqli_query($conn,"SELECT * from cattleweight where (cid ='".$_GET['cattleid']."' AND location like '%".$_GET['location']."%' )");
            ...
            <!-- ============================================================== -->
             <div class="page-breadcrumb">
                <div class="row">
                   ...
                   <form action="cattleweight_view.php" method="get">
				  <div class="card-body">
<div class="serchone">
...
<div class="col-group"><h5> Cattle weight has updated succesfully!</h5></div>
<?php } ?>
						<?php if($count == 0)
				{ ?>
				<div class="col-group">
