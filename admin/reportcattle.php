...
$conn = mysqli_connect($servername, $username, $password, $dbname);
	if(isset($_GET['fdate']))
	{
		$fdate= $_GET['fdate'];
		$tdate= $_GET['tdate'];
		$reslt = mysqli_query($conn,"select * from cattleprofile where (date BETWEEN '".$fdate."' AND '".$tdate."') and location='".$_GET['location']."'  ");
...
if(mysqli_num_rows($reslt)>0)
		...
		{
			echo "<h1>No records found for Cattle Profile<h1>";
		}
}
		?>  
</div>
