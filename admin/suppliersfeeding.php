...
$conn = mysqli_connect($servername, $username, $password, $dbname);
		...
		if(isset($_POST['submit']))
	{
		...
		$reslt = mysqli_query($conn,"INSERT INTO `suppliersfeeding`(`date`, `suppliersname`, `groupname`, `location`, `quantity`, `status`, `remarks`) VALUES ('".$date ."','".$supplier ."','".$group ."','".$location ."','".$quantity ."','".$status ."','".$remarks ."')");
...
<div class="page-wrapper">
	...
	<div class="card-body">
<a class="btn btn-primary" href="suppliersfeeding.php">feeding Suppliers</a>
<a class="btn btn-primary" href="suppliersvaccine.php">vaccine Suppliers</a>
</div>
</div>
