...
$conn = mysqli_connect($servername, $username, $password, $dbname);
		...
		if(isset($_POST['submit']))
	{
		...
		$reslt = mysqli_query($conn,"INSERT INTO `stockmilk`(`milk`, `supplementary`, `quantity`, `location`, `uptodate`, `description`, `incharge`) VALUES  ('".$milk ."','".$supplementary ."','".$quantity ."','".$location ."','".$uptodate ."','".$description ."','".$incharge ."')");
...
<a class="btn btn-primary" href="stockmilk.php">milk</a>
         ...
         <div class="ml-auto text-right">
                            <nav aria-label="breadcrumb">
                              <form action="stockmilk_view.php" method="get">
<div class="card-body">
	<input placeholder="Location" type="text" name="location">

	
	<input  type="text" placeholder="Stock Id"  name="milk">
...
<div class="card-body">
 <div class="card">
       <h4 class="card-title">Stock Milk</h4>
	   
	     <div class="form-group row">
	<label class="col-sm-3 text-right control-label col-form-label" for="psw-repeat"><b>Milk</b></label>
	 <div class="col-sm-9">
    <input class="form-control" type="text" placeholder="Enter Name of Milk" name="milk" id="milk" >
		<div id="milkerror" class="error"></div>
...
if (milk==null || milk==""){ 
document.getElementById("milkerror").innerHTML  = "Please Enter milk Name.";
