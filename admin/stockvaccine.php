...
$conn = mysqli_connect($servername, $username, $password, $dbname);
		...
		if(isset($_POST['submit']))
	{
		...
		$reslt = mysqli_query($conn,"INSERT INTO `stockvaccine`(`medicine`, `supplementary`, `quantity`, `location`, `uptodate`, `description`, `incharge`) VALUES  ('".$medicine ."','".$supplementary ."','".$quantity ."','".$location ."','".$uptodate ."','".$description ."','".$incharge ."')");
...
<a class="btn btn-primary" href="stockmilk.php">milk</a>
         ...
         <div class="ml-auto text-right">
                            <nav aria-label="breadcrumb">
                              <form action="stockvaccine_view.php" method="get">
<div class="card-body">
<input  type="text" placeholder="Location" name="location">
<input  type="text" Placeholder="Stock Id" name="medicine">
...
<div class="card-body">
 <div class="card">
       <h4 class="card-title">Stock vaccine</h4>
	   
	     <div class="form-group row">
	<label class="col-sm-3 text-right control-label col-form-label" for="psw-repeat"><b>Medicine</b></label>
	 <div class="col-sm-9">
    <input class="form-control" type="text" placeholder="Enter Name of Medicine" name="medicine" id="medicine"  >
...
document.getElementById("medicineerror").innerHTML  = "Please Enter medicine Name.";
