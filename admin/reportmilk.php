...
if(isset($_GET['fdate']))
{
	$reslt = mysqli_query($conn,"SELECT * from milkproduction where (date BETWEEN '".$_GET['fdate']."' AND '".$_GET['tdate']."') and location='".$_GET['location']."' ");
...
if(mysqli_num_rows($reslt)>0)
		...
		{
			echo "No results found of milk report";
		}
}
		?> 
</div>
