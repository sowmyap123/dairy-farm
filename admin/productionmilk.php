...
$conn = mysqli_connect($servername, $username, $password, $dbname);
		...
		if(isset($_POST['submit']))
	{
		...
		$reslt = mysqli_query($conn,"INSERT INTO `productionmilk`(`date`, `suppliersname`, `groupname`, `location`, `quantity`, `status`, `remarks`) VALUES ('".$date ."','".$supplier ."','".$group ."','".$location ."','".$quantity ."','".$status ."','".$remarks ."')");
...
<div id="statuserror" class="error"></div>
 ...
 <div class="form-group row">
	...
	<div class="border-top">
	  <div class="card-body">
    <input class="btn btn-primary" type="submit" class="btn btn-success" name="submit" value="Register" >
							</div>
						</div>
					</div>
				</form>
