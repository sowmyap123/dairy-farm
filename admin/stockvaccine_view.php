...
{
	$reslt = mysqli_query($conn,"SELECT * from stockvaccine where (medicine ='".$_GET['medicine']."' AND location like '%".$_GET['location']."%' )");
             ...
             <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">stock Vaccine Info</h4>
...
<?php if($count == 0)
				{ ?>
				<div class="col-group">
					<h3> No results Found oF <?php echo $_GET['medicine']; ?></h3>
				</div>
				 <?php
				 } else
				 {?>
	...
	<div class="form-group row">
    <label class="col-sm-3 text-right control-label col-form-label" for="psw-repeat"><b>medicine Name :</b>
    </label><div class="col-sm-9 col-form-label"><?php echo $getrows['medicine'];?></div></div>
