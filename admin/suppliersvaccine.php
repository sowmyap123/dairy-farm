...
$conn = mysqli_connect($servername, $username, $password, $dbname);
		...
		if(isset($_POST['submit']))
	{
		...
		$reslt = mysqli_query($conn,"INSERT INTO `suppliersvaccine`(`date`, `suppliersname`, `groupname`, `location`, `quantity`, `status`, `remarks`) VALUES ('".$date ."','".$supplier ."','".$group ."','".$location ."','".$quantity ."','".$status ."','".$remarks ."')");
