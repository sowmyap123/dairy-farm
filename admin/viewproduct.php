			...
			while($product = mysqli_fetch_array($query))
{
					...
					<tr>
						...
						<td><a href="edit.php?id=<?php echo $product['id'];?>">Edit</a> | <a href="javascript:void(0)" onclick="deleteRecord(<?php echo $product['id'];?>)">Delete</a></td>
