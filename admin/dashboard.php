...
$conn = mysqli_connect($servername, $username, $password, $dbname);
	if(isset($_GET['fdate']))
	{
		$fdate= $_GET['fdate'];
		$tdate= $_GET['tdate'];
	$reslt = mysqli_query($conn,"select * from suppliersfeeding a where (a.date BETWEEN '".$fdate."' AND '".$tdate."') ");
	$count=mysqli_num_rows($reslt);
	$reslt1 = mysqli_query($conn,"select * from suppliersvaccine a where (a.date BETWEEN '".$fdate."' AND '".$tdate."') ");
          ...
          <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-lg-2 col-xlg-3">
                        <div class="card card-hover">
                            <div class="box bg-success text-center">
                                <h1 class="font-light text-white"><i class="mdi mdi-github-face"></i></h1>
                                <h6 class="text-white">Cattle Profile</h6>
                            </div>
                        </div>
                    </div>
                     <!-- Column -->
                    <div class="col-md-6 col-lg-2 col-xlg-3">
                        <div class="card card-hover">
                            <div class="box bg-warning text-center">
                                <h1 class="font-light text-white"><i class="mdi mdi-octagon"></i></h1>
                                <h6 class="text-white">Cattle Weight</h6>
                            </div>
                        </div>
                    </div>
                    <!-- Column -->
                    <div class="col-md-6 col-lg-2 col-xlg-3">
                        <div class="card card-hover">
                            <div class="box bg-danger text-center">
                                ...
                                <h6 class="text-white">Cattle Food</h6>
                            </div>
                        </div>
                    </div>
                    <!-- Column -->
                    <div class="col-md-6 col-lg-2 col-xlg-3">
                        <div class="card card-hover">
                            <div class="box bg-info text-center">
                                ...
                                <h6 class="text-white">Cattle Medicine</h6>
                            </div>
                        </div>
                    </div>
                    <!-- Column -->
                    ...
                    <div class="col-md-6 col-lg-2 col-xlg-3">
                        <div class="card card-hover">
                            <div class="box bg-danger text-center">
                                <h1 class="font-light text-white"><i class="mdi mdi-nest-protect"></i></h1>
                                <h6 class="text-white">Cattle Stage</h6>
                            </div>
                        </div>
                    </div>
                    <!-- Column -->
